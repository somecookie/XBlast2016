...
public final class Player {
	...
	/**
	 * retourne le nombre max de bombes d'un joueur.
	 * @return int
	 */
	public int maxBombs(){
		return maxBombs;
	...
	public static final class DirectedPosition{
		...
		/**
		 * Retourne un couple (direction, position) avec la nouvelle position donnée. 
		 * @param newPosition
		 *          Nouvelle position donnée
		 * @return withPosition (DirectedPosition)
		 *          Position dirigée avec la position (newPosition) donnée
		 */
		...
		/**
		 * Retourne un couple (direction, position) avec la nouvelle direction donnée. 
		 * @param newDirection
		 *          Nouvelle direction donnée
		 * @return withDirection (DirectedPosition)
		 *          Position dirigée avec la direction (newDirection) donnée
		 */
