...
public enum Block {
	 ...
	 * @return true ssi le block est libre
	 */
	 ...
	 * @return true ssi un joueur peut aller sur le block
	 */
	 ...
	 * @return true ssi le block met une ombre sur le plateau de jeu
	 */
	...
	/**
	 * Méthode testant si le block est un bonus
	 * @return vrai (boolean)
	 *          ssi le block est un bonus
	 */
	...
	/**
	 * Renvoi le bonus associé au block
	 * @return associatedBonus (Bonus)
