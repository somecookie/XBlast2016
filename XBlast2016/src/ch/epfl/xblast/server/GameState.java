...
public final class GameState {
	...
	/**
	 * Retourne une liste contenant les cases où se trouvent les bonus.
	 * @param board
	 * @return List<Cell>
	 */
	...
	/**
	 * méthode qui retourne la liste des joueurs triée selon la permutation actuel.
	 * @param currentPermut
	 * @param player
	 * @return List<Player>
	 */
	...
	/**
	 * Calcule l'évolution des joueurs et renvoie une liste actualisée des ceux-ci.
	 * @param players0
	 * @param playerBonuses
	 * @param map
	 * @param board1
