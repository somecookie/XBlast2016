...
public final class RunLengthEncoder {
	 ...
	 * 
	 * @param notEncoded
	 *            the given list of byte
	 * @return the coded list
	 */
	...
	/**
	 * Return the decoded version by "plages" of the list or throw
	 * IllegalArgumentException, if the last list's value is negative
	 * 
	 * @param encoded
	 *            the given list of byte
