...
public final class SubCell {
	...
	/**
	 * Normalize the given coordinates x and y and constructs a sub cell with
	 * that coordinates
	 * 
	 * @param x
	 *            given coordinate x
	...
	/**
	 * Return the distance from the sub cell in construction to the nearest
	 * central sub cell
	 * 
	 * @return distance (int)
	 */
	...
	/**
	 * Return the sub cell's neighbor to the sub cell in construction, in the
	 * given direction
	 * 
	 * @param d
	 *            the given direction
	...
	public boolean equals(Object that) {
		...
		return (that instanceof SubCell) && (((SubCell) that).x() == x() && ((SubCell) that).y() == y());
	}
