...
public final class Lists {
	 ...
	 *          sii la liste l donnée est vide
	 * @param l
	 *          Liste donnée dont on renvoi une version symétrique
	 * @return mirrored (List<T>)
	 *          Liste symétrique à la liste l donnée
	 */
	 ...
	 * @param l
	 *          Liste donnée
	 * @return permutation (List<List<T>>)
	 *          Liste de permutations de la liste (l) donnée en arguments
	 */
